...
import { rejectTransactionSchema } from "./deposit-management.schema";
import { rejectTransaction } from "./deposit-management.action";
import { toast } from "sonner";

type RejectDepositTransactionProps = {
  transactionId: string;
  userId: string;
};

/**
 * RejectDepositTransaction component.
 *
 * This component renders a dialog with a form to reject a deposit transaction.
 ...
 *
 * @param {RejectDepositTransactionProps} props - The props containing transaction and user IDs.
 * @returns {JSX.Element} The rendered RejectDepositTransaction component.
 */
export default function RejectDepositTransaction({
  transactionId,
  userId,
}: Readonly<RejectDepositTransactionProps>): JSX.Element {
