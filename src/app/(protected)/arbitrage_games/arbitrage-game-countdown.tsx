...
interface ArbitrageGameCountdownProps {
  date: Date;
}
 ...
 *
 * @param {ArbitrageGameCountdownProps} props - The properties for the component.
 * @param {ArbitrageGameCountdownProps["date"]} props.date - The date to count down to.
 * @returns {JSX.Element} The rendered component.
 */

const ArbitrageGameCountdown: React.FC<ArbitrageGameCountdownProps> = ({
  date,
}) => {
...
export default ArbitrageGameCountdown;
